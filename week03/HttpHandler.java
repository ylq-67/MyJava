...
//        try {
//            String value = "hello,ylq"; // "hello,kimmking"; // 对接上次作业的httpclient或者okhttp请求另一个url的响应数据
...
//        }
        ...
        httpGet.setHeader("mao-ylq", (String) fullRequest.headers().get("mao-ylq"));

        System.out.println((String) fullRequest.headers().get("mao-ylq"));
